...
const Investors = () => {
  return (
    <div className="mt-24 w-full l:mt-44 flex justify-center s:w-full">
      <div className="flex flex-col CooperateCard_max_width s:w-full">
        <div className="font-poppins l:inline-flex l:flex-col font-bold text-6xl s:text-4xl s:px-10  text-white ">
