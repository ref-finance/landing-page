  ...
  return (
    <div className="relative mx-auto sm:mt-28 md:mt-28 mt-56 lg:w-4/5 sm:w-full md:w-full">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="relative z-10 grid grid-cols-5 sm:hidden place-items-center gap-y-16 mt-16 w-full">
        ...
        <div className="relative z-10 grid grid-cols-4 sm:hidden place-items-center gap-y-16 mt-16 w-full">
