...
const Footer = () => {
  ...
  return (
    <div className="mx-auto sm:mt-20 md:mt-20 lg:w-5/6 sm:w-full md:w-full mb-10">
      <div className="flex justify-center mb-32">
        <div
          onClick={goRefApp}
          className="flex items-center font-extrabold text-lg justify-center bg-primary rounded-lg cursor-pointer text-sm text-black h-16 w-64 sm:hidden md:hidden hover:bg-hightGreenColor"
        >
          Launch APP <BannerArrowIcon className="ml-2 transform scale-75" />
        </div>
      </div>
      <div className="flex justify-between text-base text-white mb-16">
        <div>
          <h1 className="font-bold mb-4">REF Token</h1>
        ...
        <div>
          <h1 className="font-bold mb-4">Exchanges</h1>
        ...
        <div>
          <h1 className="font-bold mb-4">Learn More</h1>
        ...
        <div>
          ...
          <div className="text-white text-xs float-right">@ 2023 Ref fiance Ltd</div>
        </div>
      </div>
    </div>
  );
