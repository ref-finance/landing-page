...
const Footer = () => {
  ...
  return (
    <div className="mx-auto lg:w-5/6 sm:w-full md:w-full mb-10 sm:px-9 sm:mb-8">
      ...
      <div className="flex justify-between text-base text-white mb-16 sm:flex-wrap sm:mb-0">
        ...
        <div className="sm:w-1/2 sm:mt-6">
        ...
        <div className="sm:w-1/2 sm:mt-6 sm:pl-12">
        ...
        <div className="sm:w-7/12 sm:-mt-24">
