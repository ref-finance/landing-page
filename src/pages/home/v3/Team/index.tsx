...
const Team = () => {
  ...
  return (
    <div className="relative">
      <div className="relative z-10 text-center mx-auto mt-64 md:mt-24 pl-12 pr-12 sm:w-full md:w-full sm:pl-0 sm:-ml-14">
        <div className="absolute -top-10 inset-1/3 sm:relative sm:inset-1/4">
