    ...
    <div className="relative mx-auto sm:mt-32 md:mt-28 mt-56 lg:w-4/5 sm:w-full md:w-full md:mb-64">
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="relative z-10 grid grid-cols-5 sm:hidden md:hidden gap-x-24 gap-y-16 mt-16 w-full">
          <PartnersNear className="justify-self-start self-center origin-center opacity-80 hover:opacity-100 hover:filter hover:drop-shadow-lightWhite" />
          ...
          <PartnersBurrow className="justify-self-end self-center origin-end opacity-80 hover:opacity-100 hover:filter hover:drop-shadow-lightWhite" />
        </div>
        <div className="relative z-10 flex justify-center items-center sm:hidden md:hidden gap-x-36 gap-y-16 mt-16 w-full">
          <PartnersOKEX className="justify-self-start self-center origin-center opacity-80 hover:opacity-100 hover:filter hover:drop-shadow-lightWhite" />
        ...
        <div className="relative z-10 grid grid-cols-5 sm:hidden md:hidden gap-x-24 gap-y-16 mt-16 w-full">
          <PartnersSweatEconomy className="justify-self-center self-center origin-end opacity-80 hover:opacity-100 hover:filter hover:drop-shadow-lightWhite" />
          ...
          <PartnerTransak className="justify-self-end self-center origin-center opacity-80 hover:opacity-100 hover:filter hover:drop-shadow-lightWhite" />
        </div>
